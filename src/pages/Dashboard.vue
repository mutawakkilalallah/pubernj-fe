      ...
      <div class="user-card row d-block d-flex align-items-center justify-content-center p-2 rounded">
        <div class="col-md-6 text-center">
          ...
          <div class="user-info">
            ...
            <i v-else-if="storeAuth.user.role === 'wilayah'">{{ storeAuth.user.wilayah }}</i>
  ...
  <div v-else>
    ...
    <div class="row mt-3 g-2">
      ...
      <!-- <div class="col-sm-3 mb-3 mb-sm-0" v-if="access.internal()">
        <div class="card" style="background-color: #006c8a; cursor: pointer" @click="toDataSantri">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <font-awesome-icon icon="user" style="font-size: 60px; color: white" />
              </div>
              <div class="col">
      ...
      <!-- <div class="col-sm-3 mb-3 mb-sm-0" v-if="access.internal()">
        <div class="card" style="background-color: #8a5700; cursor: pointer" @click="toDataSantri">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <font-awesome-icon icon="user-xmark" style="font-size: 60px; color: white" />
              </div>
              <div class="col">
                <h3 class="card-title text-end text-light">
                  {{ forMat(storeAuth.stast.totalTidakRombongan) }}
                </h3>
                <p class="card-text text-end fw-bold text-light">Total Tidak Rombongan</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col">
                ...
                <p class="card-text text-end fw-bold text-light">Total Dropspot</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- <div v-if="access.sysadmin()" class="col-sm-3 mb-3 mb-sm-0">
        <div class="card" style="background-color: #2a2700">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <font-awesome-icon icon="stopwatch" style="font-size: 60px; color: white" />
              </div>
              <div class="col">
                <h3 class="card-title text-end text-light">
                  {{ storeAuth.stast.totalLogin }}
                </h3>
                <p class="card-text text-end fw-bold text-light">Active Session</p>
              </div>
            </div>
          </div>
        </div>
