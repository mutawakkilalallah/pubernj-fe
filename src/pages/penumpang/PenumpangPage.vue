<template>
    ...
    <div class="col-md-2">
      ...
      >
        <option
          value=""
          selected
        >Semua Status Persyaratan</option>
  ...
  <div
    class="modal fade"
    v-if="form.isOpenCompareTagihan === true"
    :class="{ show: form.isOpenCompareTagihan }"
    style="display: block"
    id="modalEdit"
    tabindex="-1"
    aria-labelledby="modalEditLabel"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <hr />
          <b class="text-danger">Note: Jagalah privasi data. Haram disebar & dipergunakan untuk
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <p>
                {{
                  form.person.santri
                    ? `${form.person.santri.raw.umur} Tahun`
                    : "-"
                }}
              </p>
            </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div>
                    ...
                    <b class="card-text">
                      {{
                        form.dataEdit.dropspot
                          ? form.dataEdit.dropspot.nama
                          : "-"
                      }}
                    </b>
                    ...
                    <b class="card-text">
                      {{
                        form.person.dropspot
                          ? form.person.dropspot.area.nama
                          : "-"
                      }}
                    </b>
                    ...
                    <b class="card-text">
                      {{
                        form.person.dropspot
                          ? form.person.dropspot.area.no_hp
                          : "-"
                      }}
                    </b>
                  </div>
                  ...
                  <div>
                    <div>
                      ...
                      <b class="card-text">
                        {{
                          form.dataEdit
                            ? formatMinus(form.dataEdit.dropspot.harga)
                            : "-"
                        }}
                      </b>
                      ...
                      >{{
                          form.dataEdit.status_bayar === "belum-lunas"
                            ? "Belum Lunas"
                            : ""
                        }}</i>
                      <i
