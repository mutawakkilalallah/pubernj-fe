          ...
          <div class="row">
            ...
            <div class="col">
              <div class="text-center mt-5 pt-5">
                ...
                <p class="text-capitalize"><strong>Ketua Pelaksana </strong></p>
                <br>
                <br>
                <br>
                <p class="text-uppercase"><strong>Ponirin Mika, M.Pd </strong></p>
              </div>
            </div>
            <div class="col">
              <div class="float-end mt-4">
                ...
                <br>
                <br>
                <p class=""><strong>Dr. Bashori Alwi, M.H </strong></p>
